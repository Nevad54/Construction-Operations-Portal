...
const Services = () => {
  ...
  const services = [
    { title: 'General Contracting', description: 'Comprehensive project management from start to finish.' },
    { title: 'Design-Build', description: 'Integrated design and construction services for seamless delivery.' },
    { title: 'Renovations', description: 'Modernizing and upgrading existing structures.' },
    { title: 'Consulting', description: 'Expert advice on project planning and execution.' },
  ];
